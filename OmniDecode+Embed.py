...
# Hash values
hash_value1 = "paste_hash_value_1_here"
hash_value2 = "paste_hash_value_2_here"

# Reverse the hashing process to retrieve the base64 strings
BRC_69 = base64.b64decode(hash_value1[len(salt):]).decode('utf-8')
BRC_69_MD = base64.b64decode(hash_value2[len(salt):]).decode('utf-8')
...
if __name__ == "__main__":
    ...
    decode_and_embed_metadata(
        image_path,
        packet.BRC_69_MD,
        'C:\\path\\to\\your\\directory\\final_image.bmp',
        'C:\\path\\to\\your\\directory\\metadata.json'
    )
